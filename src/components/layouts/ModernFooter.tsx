...
export default function ModernFooter() {
  ...
  return (
    <footer className="bg-[#0F172A]/90 backdrop-blur-md border-t border-white/10 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/browse" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Browse Agents
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/credits" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Purchase Credits
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>
                <a href="mailto:nidhi@irizpro.in" className="hover:text-blue-400 transition-colors">
                  nidhi@irizpro.in
                </a>
              </li>
              <li>
                <a href="tel:+919370754234" className="hover:text-blue-400 transition-colors">
                  +91-9370754234
                </a>
              </li>
