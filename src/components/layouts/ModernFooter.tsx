    ...
    <footer className="bg-white border-t border-gray-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="font-semibold text-gray-900 mb-4">AI Agent Marketplace</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <a href="mailto:nidhi@irizpro.in" className="hover:text-blue-600 transition-colors">
                  nidhi@irizpro.in
                </a>
              </li>
              <li>
                <a href="tel:+919370754234" className="hover:text-blue-600 transition-colors">
                  +91-9370754234
                </a>
              </li>
